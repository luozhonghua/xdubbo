 ...
 */
package com.xdubbo.qos.common;

public interface Constants {

    int DEFAULT_PORT = 22222;//TODO  ERROR server.Server:  [DUBBO] qos-server can not bind localhost:22222, dubbo version: 2.0.0, current host: 127.0.0.1
                             //为什么会被绑定?
