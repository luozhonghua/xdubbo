...
public class Main {
    ...
    public static final String CONTAINER_KEY = "xdubbo.container";

    public static final String SHUTDOWN_HOOK_KEY = "xdubbo.shutdown.hook";
