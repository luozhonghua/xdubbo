...
import com.xdubbo.rpc.protocol.dubbo.support.DemoServiceImpl;
import com.xdubbo.rpc.protocol.dubbo.support.NonSerialized;
import com.xdubbo.rpc.protocol.dubbo.support.RemoteService;
import com.xdubbo.rpc.protocol.dubbo.support.RemoteServiceImpl;
import com.xdubbo.rpc.protocol.dubbo.support.Type;
...
public class DubboProtocolTest {
    ...
    public void testNonSerializedParameter() throws Exception {
        ...
        try {
            ...
            Assert.assertTrue(e.getMessage().contains("com.xdubbo.rpc.protocol.dubbo.support.NonSerialized must implement java.io.Serializable"));
        }
    }
