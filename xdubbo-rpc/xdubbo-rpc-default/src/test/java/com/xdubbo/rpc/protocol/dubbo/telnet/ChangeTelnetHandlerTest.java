...
public class ChangeTelnetHandlerTest {
    ...
    public void setUp() {
        ...
        mockChannel.setAttribute("telnet.service", "com.xdubbo.rpc.protocol.dubbo.support.DemoService");
        EasyMock.expectLastCall().anyTimes();
    ...
    public void testChangeName() throws RemotingException {
        DubboProtocol.getDubboProtocol().export(mockInvoker);
        String result = change.telnet(mockChannel, "com.xdubbo.rpc.protocol.dubbo.support.DemoService");
        assertEquals("Used the com.xdubbo.rpc.protocol.dubbo.support.DemoService as default.\r\nYou can cancel default service by command: cd /",
                result);
    }
    ...
    public void testChangeCancel() throws RemotingException {
        ...
        assertEquals("Cancelled default service com.xdubbo.rpc.protocol.dubbo.support.DemoService.", result);
    }
