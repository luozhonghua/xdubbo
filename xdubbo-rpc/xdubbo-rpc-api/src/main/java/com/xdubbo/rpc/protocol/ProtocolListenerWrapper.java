...
import com.xdubbo.rpc.ExporterListener;
...
import com.xdubbo.rpc.listener.ListenerExporterWrapper;
import com.xdubbo.rpc.listener.ListenerInvokerWrapper;
...
public class ProtocolListenerWrapper implements Protocol {
    static {
        try {
            //硬编码？  后续改进配置
            Class serverClass = Protocol.class.getClassLoader().loadClass("com.xdubbo.qos.server.Server");
