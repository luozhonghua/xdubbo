...
public class ParametersTest extends TestCase {
    ...
    public void testString2Parameters() throws Exception {
        String qs = "name=com.xdubbo.rpc.service.GenericService&version=1.0.15&lb=lcr";
