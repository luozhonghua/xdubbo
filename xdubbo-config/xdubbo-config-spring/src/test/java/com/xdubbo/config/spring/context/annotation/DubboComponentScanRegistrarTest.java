...
import com.xdubbo.config.spring.context.annotation.consumer.ConsumerConfiguration;
import com.xdubbo.config.spring.context.annotation.provider.DemoServiceImpl;
import com.xdubbo.config.spring.context.annotation.provider.ProviderConfiguration;
