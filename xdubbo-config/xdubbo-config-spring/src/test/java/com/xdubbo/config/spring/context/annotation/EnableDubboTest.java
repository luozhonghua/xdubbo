 ...
 */
package com.xdubbo.config.spring.context.annotation;
...
import com.xdubbo.config.spring.context.annotation.consumer.test.TestConsumerConfiguration;
import com.xdubbo.config.spring.context.annotation.provider.DemoServiceImpl;
...
public class EnableDubboTest {
    ...
    @EnableDubbo(scanBasePackages = "com.xdubbo.config.spring.context.annotation.provider")
    @ComponentScan(basePackages = "com.xdubbo.config.spring.context.annotation.provider")
