...
import static com.xdubbo.config.spring.util.BeanFactoryUtils.getBeans;
import static com.xdubbo.config.spring.util.BeanFactoryUtils.getOptionalBean;
...
abstract class AbstractAnnotationConfigBeanBuilder<A extends Annotation, B extends AbstractInterfaceConfig> {
    ...
    /**
     * Resolves the bean ids of {@link com.xdubbo.config.RegistryConfig}
     *
     * @param annotation {@link A}
