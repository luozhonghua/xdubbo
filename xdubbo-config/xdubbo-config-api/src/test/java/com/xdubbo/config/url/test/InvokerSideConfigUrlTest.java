 ...
 */
package com.xdubbo.config.url.test;
...
import com.xdubbo.config.ConsumerConfig;
import com.xdubbo.config.MethodConfig;
import com.xdubbo.config.ReferenceConfig;
import com.xdubbo.config.RegistryConfig;
import com.xdubbo.config.api.DemoService;
import com.xdubbo.config.support.MockRegistry;
...
//            {"", "", "", "", "", "", "", "", "", ""}, 
    ...
    private void initRefConf() {
        ...
        refConf.setInterface("com.xdubbo.config.api.DemoService");
