 ...
 */
package com.xdubbo.common.json;
...
public class JSONWriterTest extends TestCase {
    public void testWriteJson() throws Exception {
        ...
        // write object.
        w.getBuffer().setLength(0);
        writer.objectBegin().objectItem("type").valueString("com.xdubbo.TestService").objectItem("version").valueString("1.1.0").objectEnd();
        assertEquals(w.getBuffer().toString(), "{\"type\":\"com.xdubbo.TestService\",\"version\":\"1.1.0\"}");
        ...
        writer.objectItem("service").objectBegin().objectItem("type").valueString("com.xdubbo.TestService").objectItem("version").valueString("1.1.0").objectEnd();
        writer.objectEnd();
    }
}