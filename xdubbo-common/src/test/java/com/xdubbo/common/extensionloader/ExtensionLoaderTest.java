 ...
 */
package com.xdubbo.common.extensionloader;

import com.xdubbo.common.Constants;
import com.xdubbo.common.URL;
import com.xdubbo.common.extension.ExtensionLoader;
import com.xdubbo.common.extensionloader.activate.ActivateExt1;
import com.xdubbo.common.extensionloader.activate.impl.*;
import com.xdubbo.common.extensionloader.ext1.SimpleExt;
import com.xdubbo.common.extensionloader.ext1.impl.SimpleExtImpl1;
import com.xdubbo.common.extensionloader.ext1.impl.SimpleExtImpl2;
import com.xdubbo.common.extensionloader.ext2.Ext2;
import com.xdubbo.common.extensionloader.ext6_wrap.WrappedExt;
import com.xdubbo.common.extensionloader.ext6_wrap.impl.Ext5Wrapper1;
import com.xdubbo.common.extensionloader.ext6_wrap.impl.Ext5Wrapper2;
import com.xdubbo.common.extensionloader.ext7.InitErrorExt;
import com.xdubbo.common.extensionloader.ext8_add.AddExt1;
import com.xdubbo.common.extensionloader.ext8_add.AddExt2;
import com.xdubbo.common.extensionloader.ext8_add.AddExt3;
import com.xdubbo.common.extensionloader.ext8_add.AddExt4;
import com.xdubbo.common.extensionloader.ext8_add.impl.*;
...
public class ExtensionLoaderTest {
    ...
    public void test_getExtensionLoader_NotInterface() throws Exception {
        try {
            ...
            System.out.println(expected.getMessage());
            assertThat(expected.getMessage(),
                    containsString("Extension type(class com.xdubbo.common.extensionloader.ExtensionLoaderTest) is not interface"));
        }
    }
    ...
    public void test_getExtensionLoader_NotSpiAnnotation() throws Exception {
        try {
            ...
            System.out.println(expected.getMessage());
            assertThat(expected.getMessage(),
                    allOf(containsString("com.xdubbo.common.extensionloader.NoSpiExt"),
    ...
    public void test_getExtension() throws Exception {
        System.out.println(ExtensionLoader.getExtensionLoader(SimpleExt.class).getExtension("impl1"));
    ...
    public void test_getExtension_ExceptionNoExtension_WrapperNotAffactName() throws Exception {
        try {
            ...
            System.out.println(expected.getMessage());
            assertThat(expected.getMessage(), containsString("No such extension com.xdubbo.common.extensionloader.ext6_wrap.WrappedExt by name XXX"));
        }
    }
    ...
    public void test_AddExtension() throws Exception {
        try {
            ...
            assertThat(expected.getMessage(), containsString("No such extension com.xdubbo.common.extensionloader.ext8_add.AddExt1 by name Manual"));
        }
    ...
    public void test_AddExtension_ExceptionWhenExistedExtension() throws Exception {
        ...
        try {
            ...
            assertThat(expected.getMessage(), containsString("Extension name impl1 already existed(Extension interface com.xdubbo.common.extensionloader.ext8_add.AddExt1)!"));
        }
    }
    ...
    public void test_AddExtension_Adaptive_ExceptionWhenExistedAdaptive() throws Exception {
        ...
        try {
            ...
            assertThat(expected.getMessage(), containsString("Adaptive Extension already existed(Extension interface com.xdubbo.common.extensionloader.ext8_add.AddExt1)!"));
        }
    }
    ...
    public void test_replaceExtension_ExceptionWhenNotExistedExtension() throws Exception {
        ...
        try {
            ...
            assertThat(expected.getMessage(), containsString("Extension name NotExistedExtension not existed(Extension interface com.xdubbo.common.extensionloader.ext8_add.AddExt1)"));
        }
    }
    ...
    public void test_replaceExtension_Adaptive_ExceptionWhenNotExistedExtension() throws Exception {
        ...
        try {
            ...
            assertThat(expected.getMessage(), containsString("Adaptive Extension not existed(Extension interface com.xdubbo.common.extensionloader.ext8_add.AddExt4)"));
        }
    }
    ...
    public void test_InitError() throws Exception {
        ...
        try {
            ...
            assertThat(expected.getMessage(), containsString("Failed to load extension class(interface: interface com.xdubbo.common.extensionloader.ext7.InitErrorExt"));
