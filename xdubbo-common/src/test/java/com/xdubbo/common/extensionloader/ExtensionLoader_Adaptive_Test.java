...
import com.xdubbo.common.extensionloader.adaptive.HasAdaptiveExt;
import com.xdubbo.common.extensionloader.adaptive.impl.HasAdaptiveExt_ManualAdaptive;
import com.xdubbo.common.extensionloader.ext1.SimpleExt;
import com.xdubbo.common.extensionloader.ext2.Ext2;
import com.xdubbo.common.extensionloader.ext2.UrlHolder;
import com.xdubbo.common.extensionloader.ext3.UseProtocolKeyExt;
import com.xdubbo.common.extensionloader.ext4.NoUrlParamExt;
import com.xdubbo.common.extensionloader.ext5.NoAdaptiveMethodExt;
import com.xdubbo.common.extensionloader.ext6_inject.Ext6;
import com.xdubbo.common.extensionloader.ext6_inject.impl.Ext6Impl2;
...
public class ExtensionLoader_Adaptive_Test {
    ...
    public void test_getAdaptiveExtension_ExceptionWhenNoAdaptiveMethodOnInterface() throws Exception {
        try {
            ...
            assertThat(expected.getMessage(),
                    allOf(containsString("Can not create adaptive extension interface com.xdubbo.common.extensionloader.ext5.NoAdaptiveMethodExt"),
                            containsString("No adaptive method on extension com.xdubbo.common.extensionloader.ext5.NoAdaptiveMethodExt, refuse to create the adaptive class")));
        }
    ...
    public void test_getAdaptiveExtension_ExceptionWhenNotAdaptiveMethod() throws Exception {
        ...
        try {
            ...
            assertThat(
                    expected.getMessage(),
                    containsString("of interface com.xdubbo.common.extensionloader.ext1.SimpleExt is not adaptive method!"));
        }
    }
    ...
    public void test_urlHolder_getAdaptiveExtension_UrlNpe() throws Exception {
        ...
        try {
            ...
            assertEquals("com.xdubbo.common.extensionloader.ext2.UrlHolder argument == null", e.getMessage());
        }
        ...
        try {
            ...
            assertEquals("com.xdubbo.common.extensionloader.ext2.UrlHolder argument getUrl() == null", e.getMessage());
        }
    }
    ...
    public void test_urlHolder_getAdaptiveExtension_ExceptionWhenNotAdativeMethod() throws Exception {
        ...
        try {
            ...
            assertThat(
                    expected.getMessage(),
                    containsString("of interface com.xdubbo.common.extensionloader.ext2.Ext2 is not adaptive method!"));
        }
    }
    ...
    public void test_urlHolder_getAdaptiveExtension_ExceptionWhenNameNotProvided() throws Exception {
        ...
        try {
            ...
            assertThat(expected.getMessage(), containsString("Fail to get extension(com.xdubbo.common.extensionloader.ext2.Ext2) name from url"));
        }
    }
