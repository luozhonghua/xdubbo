...
public class ConfigUtilsTest {
    ...
    public void test_loadProperties_oneFile_notRootPath() throws Exception {
        Properties p = ConfigUtils.loadProperties("META-INF/xdubbo/internal/com.xdubbo.common.threadpool.ThreadPool", false);
   ...
   /* @Test
    public void test_loadProperties_multiFile_notRootPath() throws Exception {
        ...
        Properties p = ConfigUtils.loadProperties("META-INF/xdubbo/internal/com.xdubbo.common.status.StatusChecker", true);
