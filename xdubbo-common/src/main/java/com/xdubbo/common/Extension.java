 ...
 * Use <code>Protocol</code> as an example, its configuration file 'META-INF/xdubbo/com.xxx.Protocol' is changes from: <br/>
 * <pre>
 *     com.foo.XxxProtocol
 *     com.foo.YyyProtocol
 * </pre>
 ...
 * </p>
 *
 * @deprecated because it's too general, switch to use {@link com.xdubbo.common.extension.SPI}
 */
@Deprecated
@Documented
