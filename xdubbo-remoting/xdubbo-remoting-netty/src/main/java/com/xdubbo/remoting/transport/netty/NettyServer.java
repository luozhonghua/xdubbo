...
import com.xdubbo.common.utils.ExecutorUtil;
...
import com.xdubbo.remoting.Server;
import com.xdubbo.remoting.transport.AbstractServer;
import com.xdubbo.remoting.transport.dispatcher.ChannelHandlers;
...
public class NettyServer extends AbstractServer implements Server {
    ...
    protected void doClose() throws Throwable {
        ...
        try {
            Collection<com.xdubbo.remoting.Channel> channels = getChannels();
            if (channels != null && channels.size() > 0) {
                for (com.xdubbo.remoting.Channel channel : channels) {
                    try {
                        channel.close();
                    } catch (Throwable e) {
                        logger.warn(e.getMessage(), e);
