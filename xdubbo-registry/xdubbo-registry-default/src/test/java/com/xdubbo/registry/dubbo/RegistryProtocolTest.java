...
import com.xdubbo.registry.integration.RegistryProtocol;
...
import com.xdubbo.rpc.cluster.support.FailfastCluster;
import com.xdubbo.rpc.protocol.AbstractInvoker;
import com.xdubbo.rpc.protocol.dubbo.DubboInvoker;
...
public class RegistryProtocolTest {
    ...
    final String service = "com.xdubbo.registry.protocol.DemoService:1.0.0";
    ...
    public void testNotifyOverride_notmatch() throws Exception {
        ...
        NotifyListener listener = getListener(rprotocol);
        List<URL> urls = new ArrayList<URL>();
        urls.add(URL.valueOf("override://0.0.0.0/com.xdubbo.registry.protocol.HackService?timeout=100"));
        listener.notify(urls);
        assertEquals(true, exporter.getInvoker().isAvailable());
